...
const CACHE_KEY = 'untaggedData_mozart'
...
export default function UntaggedItems() {
    ...
    const fetchData = async (force: boolean = false) => {
        ...
        try {
            ...
            const response = await fetch('/api/untagged_mozart', {
                method: 'GET',
                headers: {
    ...
    const handleExportXLSX = () => {
        ...
        XLSX.writeFile(workbook, `Mozart-itens-sem-etiqueta-${format(new Date(), 'dd-MM-yyyy')}.xlsx`)
    }
